package com.YongChang;

import com.YongChang.config.CustomerLoginInterceptor;
import com.YongChang.config.LoginInterceptor;
...
public class ToyShoppingOnlineApplication extends WebMvcConfigurerAdapter {
    ...
    public static void main(String[] args) {
        SpringApplication.run(ToyShoppingOnlineApplication.class, args);
    }
